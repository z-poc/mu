...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="storage/favicon.ico"/>
    <!-- Font Awesome -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mu-about-left">
                                <img class="" src="storage/about.jpg" alt="Men Speaker">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mu-about-right">
                                <h2>Merőkanál Ultras</h2>
                                <p>
...
<main role="main">
    <!-- Start Video -->
    <section id="mu-video" class="green_stripe">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="video-area">
                        <h2>Legutóbb ez történt:</h2>
                        <div class="video-container">
                            <iframe src="https://www.youtube.com/embed/hef2-t4JaSQ" frameborder="0" gesture="media" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="tab-content mu-schedule-content">
                                <div role="tabpanel" class="tab-pane fade mu-event-timeline in active" id="first-day">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="mu-single-event">
                                                <img src="storage/speaker-1.jpg" alt="event speaker">
                                        ...
                                        <li>
                                            <div class="mu-single-event">
                                                <img src="storage/speaker-2.jpg" alt="event speaker">
                                        ...
                                        <li>
                                            <div class="mu-single-event">
                                                <img src="storage/speaker-3.jpg" alt="event speaker">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mu-single-price">
                                        ...
                                        <div class="mu-single-price-head">
                                            ...
                                            <span class="mu-rate">2.700</span>
                                        </div>
                                        <h3 class="mu-price-title">Csak póló</h3>
                                        <ul>
                                            <li>Fekete MU póló</li>
                                        </ul>
                                ...
                                <div class="col-md-4">
                                    <div class="mu-single-price mu-popular-price">
                                        <div class="mu-single-price-head">
                                            <span class="mu-currency">HUF</span>
                                            <span class="mu-rate">9.000</span>
                                        </div>
                                        <h3 class="mu-price-title">Túra + Póló</h3>
                                        <ul>
                                            <li>Fekete MU póló</li>
                                            <li>Meccs jegy</li>
                                            <li>Helyfoglalás a buszon</li>
                                        </ul>
                                        <a class="mu-register-btn" href="#mu-register"> Register Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mu-single-price">
                                        ...
                                        <h3 class="mu-price-title">Csak túra</h3>
                                        <ul>
                                            <li>Meccs jegy</li>
                                            <li>Helyfoglalás a buszon</li>
                                        </ul>
